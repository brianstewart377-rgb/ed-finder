...
async def put_profile_sync(
    ...
    # Serialise once — both for the size check and for the COPY-style
    # JSONB write below. We can't trust the client's content-length.
    payload = json.dumps(body.blob, separators=(',', ':'))

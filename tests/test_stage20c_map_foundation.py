...
MAP_VIEW_PATH = ROOT / 'frontend-v2' / 'src' / 'features' / 'system-detail' / 'simulation-preview' / 'MapFoundationWorkspaceView.tsx'
MAP_TAB_PATH = ROOT / 'frontend-v2' / 'src' / 'features' / 'map' / 'MapTab.tsx'

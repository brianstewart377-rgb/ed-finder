...
def test_v3_map_validation_uses_fresh_babylon_stack_in_both_browser_lanes():
    ...
    assert 'the legacy `frontend/` React app is no longer built or exercised by the V3 product lane and is not the visual oracle for the new product' in authority

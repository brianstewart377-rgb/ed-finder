...
REGISTERED_SCENARIOS: tuple[ScenarioDefinition, ...] = (
    ScenarioDefinition(
        ...
        accessibility_checks=('modal_escape_close', 'keyboard_open_planner', 'mobile_telemetry_toggle'),
        viewport_checks=('known narrow viewport overflow observation',),
        product_observation_policy='Record the known PR #259 narrow viewport overflow without failing environment readiness.',
    ...
    ScenarioDefinition(
        ...
        accessibility_checks=(),
        viewport_checks=('known narrow viewport overflow observation',),
        product_observation_policy='Record the known PR #259 narrow viewport overflow without blocking environment readiness.',
    ...
    ScenarioDefinition(
        ...
        api_contracts=('support_route_matrix', 'events_live', 'events_recent', 'watchlist', 'cache_stats', 'facility_templates', 'simulation_summary', 'slot_predictions'),
        browser_journey=(),

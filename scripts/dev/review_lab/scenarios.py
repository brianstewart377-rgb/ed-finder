...
REGISTERED_SCENARIOS: tuple[ScenarioDefinition, ...] = (
    ScenarioDefinition(
        ...
        api_contracts=('health', 'finder', 'system_detail', 'news_latest', 'system_archetype', 'evidence_summary', 'facility_templates', 'simulation_summary', 'slot_predictions'),
        browser_journey=(
    ...
    ScenarioDefinition(
        ...
        required_review_only_routes=('/api/archetypes/system/{id64}', '/api/evidence/systems/{id64}/summary', '/api/facility-templates', '/api/systems/{id64}/simulation-summary', '/api/systems/{id64}/slot-predictions'),
    ...
    ScenarioDefinition(
        ...
        required_review_only_routes=('/api/events/live', '/api/events/recent', '/api/news/latest', '/api/v2/watchlist/{sync_key}', '/api/cache/stats'),
        api_contracts=('events_live', 'events_recent', 'news_latest', 'watchlist', 'cache_stats'),
        browser_journey=(),
    ...
    ScenarioDefinition(
        ...
        required_review_only_routes=('/api/v2/watchlist/{sync_key}', '/api/cache/stats', '/api/archetypes/system/{id64}', '/api/evidence/systems/{id64}/summary'),
    ...
    ScenarioDefinition(
        ...
        api_contracts=('support_route_matrix', 'events_live', 'events_recent', 'news_latest', 'watchlist', 'cache_stats', 'system_archetype', 'evidence_summary', 'facility_templates', 'simulation_summary', 'slot_predictions'),
        browser_journey=(),

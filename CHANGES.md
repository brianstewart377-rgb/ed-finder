...
**Commander History / Journal is now an explicit product capability** - The
Journal page owns useful history, statistics, records, filters and expeditions;
Galaxy shows where personal facts happened and System Map shows what happened
at body level. Contracts now cover bidirectional spatial queries, Finder ×
Journal predicates, timestamp-supported history, personal/global Codex and
Journal/public-source separation, stable observation/body identity, and honest
event-by-event capability gaps. Later ownership is 27F for data/import readiness,
Journal analytics, Galaxy/reverse-query/Finder integration; 27H for System/body
contributions; and 27L for timeline/playback. Synthetic fixtures remain
mandatory and real logs are opt-in, privacy-safe supplemental data only.

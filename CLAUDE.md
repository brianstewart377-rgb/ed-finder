...
spatial density pyramid decoupled from ratings generation and independently
published (migration 012, #743), its governed prod build still fail-closed-blocked
until the generation is READY; map #2b next) is in `docs/ROADMAP.md` "Programme
status — 2026-09-19"; the live promotion boundary is

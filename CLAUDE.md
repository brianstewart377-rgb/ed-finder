...
**Deferred work:** Accounts/auth, journal A-2/A-3, score-weighted corridor
routing, and every later Stage 27 implementation not explicitly authorized by
the accepted stage sequence. The old real-star LOD Phase 1/2/3 order is
superseded; its reusable evidence is inherited by Stage 27D/27E.

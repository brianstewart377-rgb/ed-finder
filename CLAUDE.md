...
migration, governance and cross-repo contracts. Stage 27A can authorize Stage
27B only after owner acceptance; do not implement or wire a Babylon runtime in 27A.
...
- Spatial-platform work is authorized only through `docs/ROADMAP.md` and the
  Stage 27 contracts. Stage 27A is docs/audit only; 27B requires owner acceptance
  of 27A and explicit authorization.

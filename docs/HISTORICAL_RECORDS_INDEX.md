...
| `docs/colonisation-redesign/stage-17p-current-state-forward-plan.md` | `superseded_reference` | No | `docs/ai/CURRENT_STAGE.md`, then `docs/DOCUMENTATION_INDEX.md`, then `docs/colonisation-redesign/stage-25-roadmap.md`, then live GitHub branch and PR state | Retained for provenance and earlier planning context | No for this header-only batch; yes before any later physical move, rename, archive, or deletion |
| `docs/colonisation-redesign/stage-21-roadmap.md` | `superseded_reference` | No | `docs/ai/CURRENT_STAGE.md`, then `docs/DOCUMENTATION_INDEX.md`, then `docs/colonisation-redesign/stage-25-roadmap.md`, then live GitHub branch and PR state | Retained for provenance and post-20 planning history | No for this header-only batch; yes before any later physical move, rename, archive, or deletion |
| Older completed roadmaps and operations records under `docs/colonisation-redesign/` and older completed records under `docs/ai/`, excluding the explicit Stage 17P and Stage 21 entries above | `historic_reference` | No | `docs/ai/CURRENT_STAGE.md`, `docs/DOCUMENTATION_INDEX.md`, then the named current roadmap or active contract | Provenance, historical reasoning, and audit trace | Yes |
...
| D2a hierarchy enforcement records in `docs/ai/CURRENT_STAGE.md` and PR `#306` lineage | `historic_reference` | No | `docs/ai/CURRENT_STAGE.md` then live GitHub PR history | Records the completed D2a merge provenance | No |
| D2b D2a merge reconciliation records in `docs/ai/CURRENT_STAGE.md` and PR `#307` lineage | `historic_reference` | No | `docs/ai/CURRENT_STAGE.md` then live GitHub PR history | Records the completed D2b reconciliation provenance | No |

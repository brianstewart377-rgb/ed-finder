...
1. [`stage-20-roadmap.md`](./stage-20-roadmap.md) - active Stage 20 planning baseline after Stage 19AY.
2. [`stage-17p-current-state-forward-plan.md`](./stage-17p-current-state-forward-plan.md) - current Colony Planner baseline and continuing product boundaries.
3. [`engine-roadmap.md`](./engine-roadmap.md) - broad engine history and delivered stage summaries.
4. [`enrichment-roadmap.md`](./enrichment-roadmap.md) - station/body/ring enrichment, warehouse, and operator-roadmap work.
5. Specific historical stage docs only when the task directly touches that feature.
...
[`stage-20-roadmap.md`](./stage-20-roadmap.md) is the active Stage 20 planning baseline. It starts after Stage 19AY and keeps Stage 19 production activation, canonical apply, rebaseline, and scheduler/service work deferred.
...
|---|---|---|
| [`stage-20-roadmap.md`](./stage-20-roadmap.md) | Active Stage 20 control | Planning baseline, primary objective, workstreams, checkpoints, and Stage 19 deferred-production boundaries. |

...
| [`spatial-platform-product-contract.md`](./spatial-platform-product-contract.md) | Active Stage 27 product, truth, Commander History/Journal and acceptance authority. |
...
| [`stage-27a-spatial-capability-inventory.md`](./stage-27a-spatial-capability-inventory.md) | ED-Finder/CRE/CPE ownership plus Journal event/capability audit. |
| [`stage-27a-system-map-data-readiness.md`](./stage-27a-system-map-data-readiness.md) | System and Commander History body identity, exposure, coverage and provenance audit. |

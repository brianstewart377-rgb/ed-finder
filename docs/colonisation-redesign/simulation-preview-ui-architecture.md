...
| `hooks/useSimulationPreviewPlan.ts` | Focused plan-state hook for target archetype, placements, start mode, recommended/initial/blank plan loading, optimiser candidate loading, and optimiser-origin edit tracking. |

...
Python note: this handoff predates the repository-wide runtime migration. Current
backend and tooling work requires CPython 3.14; do not use an older interpreter
fallback. The historical environment limitation described here is no longer
current authority.

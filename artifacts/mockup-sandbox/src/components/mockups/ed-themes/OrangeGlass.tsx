...
export function OrangeGlass() {
  const css = `
    ...
    /* ── Root: cool dark grey — same palette as the live app ── */
    .og-root {
      font-family: 'Rajdhani', sans-serif;
      background:
        radial-gradient(ellipse at 20% 0%,  rgba(255,106,0,0.06) 0%, transparent 45%),
        radial-gradient(ellipse at 80% 100%,rgba(255,106,0,0.04) 0%, transparent 40%),
        linear-gradient(170deg, #080b10 0%, #0a0d14 55%, #060810 100%);
      color: #d0d8e8;
      min-height: 100vh;
      display: flex;
    ...
    .og-root::before {
      ...
      background-image:
        radial-gradient(1px 1px at  9% 17%, rgba(255,255,255,0.16) 0%, transparent 100%),
        radial-gradient(1px 1px at 44% 61%, rgba(255,255,255,0.10) 0%, transparent 100%),
        radial-gradient(1px 1px at 72% 27%, rgba(255,255,255,0.13) 0%, transparent 100%),
        radial-gradient(1px 1px at 87% 73%, rgba(255,255,255,0.08) 0%, transparent 100%),
        radial-gradient(1px 1px at 30% 84%, rgba(255,255,255,0.11) 0%, transparent 100%),
        radial-gradient(1px 1px at 62%  8%, rgba(255,255,255,0.09) 0%, transparent 100%),
        radial-gradient(1px 1px at 18% 52%, rgba(255,255,255,0.07) 0%, transparent 100%);
    }
    ...
    .og-logo {
      ...
      box-shadow: 0 0 18px rgba(255,106,0,0.40), inset 0 0 12px rgba(255,106,0,0.07);
      flex-shrink: 0;
    }
    .og-title {
    ...
    .og-sub { font-size: 11px; color: rgba(155,170,187,0.65); letter-spacing: 3px; text-transform: uppercase; }
    .og-spacer { flex: 1; }
    .og-badge {
    ...
    .og-syncbtn {
      ...
      box-shadow: 0 2px 18px rgba(255,90,0,0.32);
    }

    /* ── Tabs: grey glass + orange active ── */
    .og-tabs {
    ...
    .og-tab {
      ...
      border-bottom: 3px solid transparent; color: rgba(155,170,187,0.50);
    ...
    /* ── Panels: grey glass with orange tint border ── */
    .og-panel {
      background: rgba(255,255,255,0.04);
      backdrop-filter: blur(16px); -webkit-backdrop-filter: blur(16px);
    ...
    .og-panel-icon { color: #ff7a00; font-size: 14px; filter: drop-shadow(0 0 5px rgba(255,106,0,0.55)); }
    .og-panel-title {
      font-family: 'Orbitron', monospace; font-size: 10px; font-weight: 600;
      letter-spacing: 1.5px; text-transform: uppercase; color: rgba(208,216,232,0.88); flex: 1;
    }
    ...
    .og-input:focus { border-color: rgba(255,106,0,0.45); box-shadow: 0 0 12px rgba(255,106,0,0.14); }
    ...
    /* ── Cards: grey glass + orange accent border + hover glow ── */
    .og-card {
      background: rgba(255,255,255,0.04);
    ...
    .og-card:hover {
      ...
      box-shadow: 0 14px 42px rgba(0,0,0,0.5), 0 0 0 1px rgba(255,106,0,0.10), 0 4px 24px rgba(255,90,0,0.10);
    }
    .og-card-hdr {
    ...
    /* Rating badge coloured by economy */
    ...
    .og-rating {
      ...
      border-radius: 8px; padding: 5px 11px; min-width: 46px; text-align: center;
    }
    ...
    .og-tag {
      ...
      background: rgba(255,255,255,0.06); border: 1px solid rgba(255,255,255,0.12); color: rgba(208,216,232,0.80);
    }
    ...
    .og-btn {
      ...
      color: rgba(208,216,232,0.65); cursor: pointer; font-family: 'Rajdhani', sans-serif;
      font-weight: 600; transition: all 0.15s;
    }
    .og-btn:hover { background: rgba(255,255,255,0.10); border-color: rgba(255,255,255,0.20); color: #d0d8e8; }
    .og-btn.primary {
      background: rgba(255,106,0,0.14); border-color: rgba(255,106,0,0.40); color: #ff8c33;
    }
    .og-btn.primary:hover { background: rgba(255,106,0,0.24); }
  `;

  const systems = [
    { name: 'Colonia Gateway', economy: 'High Tech',   dist: '22,000 ly', tags: [['High Tech','eco-hightech'],['Industrial','eco-industrial']], pop: '2.1B', slots: 7,  bodies: 23, star: 'F-class', sec: 'High'   },
    { name: 'Eravate',         economy: 'Industrial',  dist: '34.2 ly',   tags: [['Industrial','eco-industrial'],['Refinery','eco-refinery']],  pop: '450M', slots: 5,  bodies: 14, star: 'G-class', sec: 'Medium' },
    { name: 'Lave',            economy: 'Agriculture', dist: '108.5 ly',  tags: [['Agriculture','eco-agriculture'],['Tourism','eco-tourism']],   pop: '1.2B', slots: 6,  bodies: 18, star: 'K-class', sec: 'High'   },
    { name: 'Alioth',          economy: 'Military',    dist: '82.6 ly',   tags: [['Military','eco-military'],['Service','']],                   pop: '8.4B', slots: 4,  bodies: 11, star: 'A-class', sec: 'High'   },
  ];

  // Rough score to simulate existing app rating logic
  const scores: Record<string, number> = { 'Colonia Gateway': 94, 'Eravate': 88, 'Lave': 81, 'Alioth': 76 };
      ...
      <div className="og-body">
        ...
        <div className="og-content">
          <div className="og-summary">
            ...
            <span>·</span><span style={{ color: 'rgba(155,170,187,0.5)' }}>⏱ 843ms</span>
            <div style={{ flex: 1 }} />
          ...
          {systems.map((sys, i) => {
            ...
            const score = scores[sys.name] ?? 75;
            return (
              <div className="og-card" key={i}>
                <div className="og-card-hdr">
                  <div className="og-rating-wrap">
                    <span className="og-rating" style={{ background: badge.bg, boxShadow: `0 2px 14px ${badge.glow}` }}>{score}</span>

 ...
 *   2. Locally: `cd frontend && yarn types:gen` (with the API on :8000).
...
/** A lossless journal event staged by the Powerplay importer. */
export type PowerplayJournalEventInput = Schemas['PowerplayJournalEventInput'];

...
export function PlannerGuidanceList({
  ...
  return (
    <div className="rounded-sm border border-border/50 bg-bg3/30 px-2 py-2" data-testid="planner-guidance">
...
function severityClass(severity: PlannerGuidanceItem['severity']): string {
  ...
  return `inline-flex rounded-sm border px-1.5 py-0.5 uppercase tracking-[0.12em] ${cls}`;
}

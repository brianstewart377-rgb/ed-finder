...
export function createSpatialFixture(count: FixtureTier): GalaxySceneContract {
  ...
  return {
    ...
    contributions: [{ id: 'deterministic-galaxy', owner: 'ED_FINDER_BASE', revision: 1, layers: [{ id: 'synthetic-stars', version: 1, representation: 'AUTHORITATIVE', payload: objects, targetCount: count, truncated: false }] }],
  };
}

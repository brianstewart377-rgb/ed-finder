...
describe('real-star cross-fade', () => {
  ...
  it('advances from the supplied frame delta and reaches both targets', () => {
    let state = beginRealStarFade({ heatmapOpacity: 1, densitySwirlOpacity: 0, starsOpacity: 0 });
    const targets = { heatmapOpacity: 0, densitySwirlOpacity: 0, starsOpacity: 1 };
  ...
  it('invalidates a demand canvas until a target change finishes', () => {
    ...
    const initial = { heatmapOpacity: 1, densitySwirlOpacity: 0, starsOpacity: 0 };
    const detail = { heatmapOpacity: 0, densitySwirlOpacity: 0, starsOpacity: 1 };

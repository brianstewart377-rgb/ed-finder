...
/** ── Per-body-type dual-range filter contract used by the active search UI ── */
...
export const BODY_SLIDERS = [
  ...
  { key: 'elw',        label: 'Earth-like',         color: '#4ade80', max: 6  },
  { key: 'ww',         label: 'Water Worlds',       color: '#60a5fa', max: 6  },
  { key: 'ammonia',    label: 'Ammonia Worlds',     color: '#fb923c', max: 6  },

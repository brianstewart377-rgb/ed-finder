    ...
    return (
      <div className="space-y-2">
        ...
        <p className="text-[10px] leading-snug text-silver-dk font-mono">
          The API reads a configured JSON artifact generated by the station enrichment status helper. It does not run enrichment, Docker, external provider, or database work from this page.
        </p>
      </div>
    );
  }

  ...
  return (
    <div className="border-b border-border/60 px-4 py-2">
      <div className="flex flex-wrap gap-2 font-mono text-[10px] uppercase tracking-[0.14em]">
        ...
        <span className="rounded border border-cyan/35 bg-cyan/10 px-2 py-1 text-cyan">Suggested Builds</span>
        ...
        <span className="rounded border border-border bg-bg3 px-2 py-1 text-silver-dk">Observed Evidence · Later step</span>
        {/* Stage 6D adds the in-page Validation section label. Cyan
            ...
            verdict. */}
        <span className="rounded border border-border bg-bg3 px-2 py-1 text-silver-dk">Validation · Later step</span>
      </div>
    </div>
  );
}

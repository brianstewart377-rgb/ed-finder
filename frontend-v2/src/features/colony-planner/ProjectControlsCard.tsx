    ...
    <section className="rounded border border-cyan/25 bg-cyan/5 p-2" data-testid="project-card">
      ...
      <div className="mt-3">
        <button
          ...
          className="w-full rounded border border-border/60 bg-bg3/45 px-2 py-1.5 font-mono text-[10px] uppercase tracking-[0.12em] text-silver-dk hover:border-orange/45 hover:text-orange"
        >
          {detailsOpen ? 'Hide project details' : 'Project details'}
        </button>

        {detailsOpen && (
          <div className="mt-2 space-y-2 rounded border border-border/60 bg-bg3/30 p-2">
            <label className="block space-y-1">
